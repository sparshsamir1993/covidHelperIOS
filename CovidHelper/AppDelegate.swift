...
//        let hospitalListController = window!.rootViewController as! HospitalListController
//        hospitalListController.hospitalStore = hospitalStore
//        let itemStore = ItemStore()
//        let itemsController = window!.rootViewController as! ItemsVewController
//        itemsController.itemStore = itemStore
        let hospitalStore =  HospitalListStore()
        let hospitalListController = HospitalListController()
        hospitalListController.hospitalStore = hospitalStore
        return true
    }
